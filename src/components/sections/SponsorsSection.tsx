      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground">
            Thank you to our amazing partners making this event possible
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20 max-w-2xl mx-auto">
            <div className="p-8">
              <h4 className="text-2xl font-bold mb-4">Interested in Sponsoring?</h4>
              <p className="text-muted-foreground mb-6">
                Partner with us to connect with talented students and support innovation
              </p>
